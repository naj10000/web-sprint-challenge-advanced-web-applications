...
1. Explain what a token is used for.
   A token is used for user login authentication.
2. What steps can you take in your web apps to keep your data secure?
    We can make private routes to certain pages, that can only be accessed with certain tokens
3. Describe how web servers work.
     Web servers store data/code from different websites to be shared across the world at all times. Servers 'host' websites or apps.
